...
public class Emotions {
    ...
    private void enqueueIMC(final InterModEnqueueEvent event) {
        ...
        InterModComms.sendTo("emotions", "helloworld", () -> {
    ...
    public void onPlayerTick(TickEvent.PlayerTickEvent event){
        if(event.player instanceof AbstractClientPlayer clientPlayer){
            ...
            if(clientPlayer.isCrouching()) SkinSwapper.setSkinFor(clientPlayer, new ResourceLocation(""));
            else SkinSwapper.resetSkinFor(clientPlayer);
        }
    }
